...
# 目标URL列表
urls = [
    'https://ses.ustc.edu.cn/wdxz/list.htm',
    'https://ses.ustc.edu.cn/1712/list.htm'
]

# 基础URL，用于处理相对路径
base_url = 'https://ses.ustc.edu.cn'

# 目标保存路径
save_path = 'cache/GMH/eng'
...
def parse_list_page(element):
    ...
    article_xpath = "//div[@class='list_items']//a/@href"
    title_xpath = "//div[@class='list_items']//a//div[@class='title']/text()"
    date_xpath = "//div[@class='list_items']//a//div[@class='date']/text()"
...
def parse_article_page(element):
    ...
    file_title_xpath = "//div[@class='wp_articlecontent']//a/text()"
    ...
    return files, processed_titles, article_text
